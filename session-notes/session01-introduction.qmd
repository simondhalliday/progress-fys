...
Since 2021, CORE Econ has posed the same question — *What is the most pressing problem that economists should address?* — to students on the first day of introductory economics courses at universities in the United States, Italy, the UK, and beyond.
...
<figure style="margin-block: var(--sp-xl);">
  <img src="https://core-understanding-our-economy-media.netlify.app//uoe-101/images/web/preface-word-cloud.svg"
       alt="Word cloud of student responses to 'What is the most pressing problem economists should address?' from universities in the USA, Italy, and UK, 2024–25. Largest words include inequality, climate change, poverty, and housing."
  ...
  <figcaption style="font-family: var(--font-sans); font-size: 0.78rem; color: var(--ink-light); margin-top: var(--sp-sm);">
    Student responses to "What is the most pressing problem that economists should address?" at universities in the USA, Italy, and UK, 2024–25. Word size reflects frequency of mention. Source: CORE Econ / <em>Understanding Our Economy</em>.
  </figcaption>
</figure>
```
