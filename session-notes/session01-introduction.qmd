...
**Sets up:** Everything. The opening reflection establishes a baseline that the course will complicate. [Session 2](session02-chimpanzee-test.html) begins the empirical work: are our instincts about the world's biggest problems accurate?
...
No reading assigned for Session 1. The first reading (Rosling, *Factfulness*, Introduction + Chapter 1) is assigned for [Session 2](session02-chimpanzee-test.html) (Thu Sep 3).
